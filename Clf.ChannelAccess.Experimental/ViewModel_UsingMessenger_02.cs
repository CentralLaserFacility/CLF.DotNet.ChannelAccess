//
// ViewModel_UsingMessenger_02.cs
//
...
namespace Clf.ChannelAccess.Experimental.Messenger_02
{
  ...
  : CommunityToolkit.Mvvm.Messaging.IRecipient<Clf.ChannelAccess.StateChangedMessage>
  {
    ...
    private EventsDictionary m_eventsDictionary = new() ;

    private void AddEventHandlersForChannel (
      IChannel                 channel,
      System.Action<bool>      connectionChangedHandler,
      System.Action<ValueInfo> valueChangedHandler
    ) {
      m_eventsDictionary.Add(
        channel,
    ...
    public ViewModel_UsingMessenger ( )
    {
      ...
      CommunityToolkit.Mvvm.Messaging.WeakReferenceMessenger.Default.Register<
        Clf.ChannelAccess.StateChangedMessage
      >(
        this
      ) ;
      //
  ...
  public class Test_ViewModel_UsingMessenger_02
  {
